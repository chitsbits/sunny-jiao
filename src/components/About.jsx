export const About = () => (
  <div className="flex flex-col md:flex-row items-center justify-center min-h-dvh px-4 sm:px-8 md:px-16 lg:px-32 gap-8 pt-20 max-w-7xl mx-auto">
    <div className="flex flex-col w-full md:w-3/5 max-w-lg">
      <h1 className="text-2xl md:text-3xl font-bold">Hey, I'm Sunny!</h1>
      <p className="mt-4 text-lg sm:text-xl">
        I'm a 4th year Computer Engineering student at the University of
        Waterloo in Ontario, Canada 🇨🇦.
      </p>
      <p className="mt-4 text-lg sm:text-xl">
        Through various internships and projects, I've gained experience in
        full-stack development, automation, infrastructure engineering, and ML.
      </p>
      <p className="mt-4 text-lg sm:text-xl">
      ...
      <p className="mt-4 text-lg sm:text-xl">
        I'm always looking for new opportunities to learn and grow, so feel free
        to reach out!
      </p>
    </div>
    <div className="w-full md:w-2/5 flex justify-center mb-15 md:mb-0 mt-8 md:mt-0">
      <img
